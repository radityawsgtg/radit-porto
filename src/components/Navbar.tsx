...
const navLink = [
    {name: "Home", href: '#home', key: 'home', icon: '/home-icon.svg'},
...
export default function Navbar(){
    ...
    return(
        <nav className='fixed top-0 left-0 w-full h-auto flex items-center z-50 overflow-hidden'>
            ...
            <div className='mr-40 ml-10 w-16 '>
