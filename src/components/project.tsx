...
import { GameDev } from "@/data/project.js";
import { MachineLearning } from "@/data/project.js";
                        ...
                        <div className="rounded-2xl bg-[#340F5C] z-10 w-full mx-auto max-w-4xl h-auto justify-center relative mt-10 bg-linear-to-b from-[#6F20C2] to-[#471F72] shadow-lg gap-10 p-1 group-hover:shadow-[0_0_50px_rgba(168,85,247,0.7)] group-hover:bg-linear-to-b group-hover:from-[#b672ff] group-hover:to-[#e9d5ff] transition-all duration-300">         
                            <div className="p-20 bg-[#340F5C] w-full h-full rounded-2xl flex flex-row gap-8">         
                                ...
                                <div className="w-1/2 text-white text-left">
                                    ...
                                    <div className="absolute bottom-0 translate-y-5/8 left-1/2 transform -translate-x-1/2 p-2 group-hover:scale-105 transition-all duration-300">
                        ...
                        <div className="rounded-2xl bg-[#340F5C] z-10 w-full mx-auto max-w-4xl h-auto justify-center relative mt-10 bg-linear-to-b from-[#6F20C2] to-[#471F72] shadow-lg gap-10 p-1 group-hover:shadow-[0_0_50px_rgba(168,85,247,0.7)] group-hover:bg-linear-to-b group-hover:from-[#b672ff] group-hover:to-[#e9d5ff] transition-all duration-300">         
                            <div className="p-20 bg-[#340F5C] w-full h-full rounded-2xl flex flex-row gap-8">         
                                ...
                                <div className="w-1/2 text-white text-left">
                                    ...
                                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 group-hover:scale-105 transition-all duration-300">                         
                                        <Image className="drop-shadow-[0_0_5px_#FFD88C]" src="/gdev.png" alt="Tag" width={400} height={400} />  
                                    </div>
                                    <div className="absolute bottom-0 translate-y-5/8 left-1/2 transform -translate-x-1/2 p-2 group-hover:scale-105 transition-all duration-300">
                                        <Image className="drop-shadow-[0_0_10px_#693a9c]" src="/lihatp.png" alt="Tag" width={400} height={400} />
                                    </div>
                        ...
                        <div className="rounded-2xl bg-[#340F5C] z-10 w-full mx-auto max-w-4xl h-auto justify-center relative mt-10 bg-linear-to-b from-[#6F20C2] to-[#471F72] shadow-lg gap-10 p-1 group-hover:shadow-[0_0_50px_rgba(168,85,247,0.7)] group-hover:bg-linear-to-b group-hover:from-[#b672ff] group-hover:to-[#e9d5ff] transition-all duration-300">         
                            <div className="p-20 bg-[#340F5C] w-full h-full rounded-2xl flex flex-row gap-8">         
                                ...
                                <div className="w-1/2 text-white text-left">
                                    ...
                                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 group-hover:scale-105 transition-all duration-300">                         
                                        <Image className="drop-shadow-[0_0_5px_#FFD88C]" src="/ML.png" alt="Tag" width={400} height={400} />  
                                    </div>
                                    <div className="absolute bottom-0 translate-y-5/8 left-1/2 transform -translate-x-1/2 p-2 group-hover:scale-105 transition-all duration-300">
                                        <Image className="drop-shadow-[0_0_10px_#693a9c]" src="/lihatp.png" alt="Tag" width={400} height={400} />
                                    </div>
