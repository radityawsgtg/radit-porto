...
export const ProjectWeb = [
    ...
    {
        id: 3, 
        name: "Wisuda Oktober ITB 2025", 
        imageUrl: "/images/Wsok.png", 
        projectUrl: "https://wisokto2025.wisudaitb.id", 
        description: "Worked as a Backend Engineer for the Wisuda Oktober ITB 2025 website, responsible for developing the graduate data and thesis (Tugas Akhir) management system, implementing an efficient search feature, and maintaining server performance and traffic stability during high-traffic periods.",
        technologies: ["React", "Node.js", "MongoDB", "Express"]},
    {
        id: 4,
        name: "SaTe Alumni Satu Teladan App", 
        imageUrl: "/images/sate.png", 
        projectUrl: "", 
        description: "Built the frontend for a mobile app that connects alumni and current students of SMAN 1 Teladan Yogyakarta, with emphasis on responsive layouts, reusable components, and user-friendly design.",
        technologies: ["React", "Node.js", "MongoDB", "Express"]},
